# FeatherMark Local Beta 0.1.0 — Verification Summary
...
| Native smoke | `./target/release/feathermark` lifecycle via test-control | Passed |
| Build-input hash | `shasum -a 256 target/release/feathermark` | `151a8d9832d73175cff2d6e2a4bdfe95534d79c7dabffcb14643f6c214ab5695` |

### Linux (Niko — NUCBox, Ubuntu 24.04 x86_64)

| Gate | Command | Result |
|------|---------|--------|
| Compile (release) | `cargo build --release -p feathermark-app --no-default-features --features linux-gtk --locked` | Passed |
| Product tests | `cargo test -p feathermark-app --no-default-features --features linux-gtk,test-control --locked` | Passed |
| Lifecycle gate | 50-cycle WebKitGTK create/navigate/destroy under Xvfb `:99` | Passed |
| Build-input hash | `shasum -a 256 target/release/feathermark` | `d3f9106118d6bbe042b97810ad5f14757a72cbfc3e79bf9bdc073601c4346b0e` |
...
|----------|------|---------|
| `FeatherMark-0.1.0-macos-arm64.app.zip` | 1,835,805 | `2531e793a2a4f037dd4aee89a5bf1ec8efc7135b1510eb09df6f8810958d9e47` |
| `FeatherMark-0.1.0-macos-arm64.dmg` | 2,314,976 | `708dbbf6d324bf6d6af5f6b291e873c1744765fa560618bfe9f1502cf03e5c2d` |
...
| Artifact | Size | SHA-256 |
|----------|------|---------|
| `FeatherMark-0.1.0-linux-x86_64.tar.zst` | 659,903 | `732199c93d54ad3ee4aa1a3dd89bb12e948c7fd366a3a7dae57f95b902264e27` |
| `feathermark_0.1.0_amd64.deb` | 660,308 | `6d9322584fbf875990a0f9ef813df6820cb1bd00606de8734f76ed974389b95f` |
| `feathermark-0.1.0-1.x86_64.rpm` | 789,248 | `3369d028b9ff9ff07e32c585c337eea200526a9a53b37e518fc83b27cda276f9` |
