...
- Cross-built `feathermark-app` (`--no-default-features --features macos-shell --locked --target x86_64-apple-darwin`) on an Apple Silicon host (arm64, macOS 26.5.1) from main @ `e92db7c`.
