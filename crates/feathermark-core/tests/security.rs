use feathermark_core::{SafeNode, SourceAttributes, SourceBlockKind};
...
fn typed_links_can_only_contain_the_shared_safe_link_target() {
    ...
    assert_eq!(
        html,
        "<a role=\"link\" tabindex=\"0\" data-feathermark-url=\"https://example.com/path\">go</a>"
    );
...
fn source_attributes_are_generated_and_kind_is_a_fixed_enum() {
    let attrs = SourceAttributes::new(4, 2, 8, 0, SourceBlockKind::Paragraph);
