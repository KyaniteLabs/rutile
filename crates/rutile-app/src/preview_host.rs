...
use rutile_core::MAX_RENDERED_PAGE_BYTES;
use rutile_protocol::{
...
const CSS_URL: &str = "rutile://preview/v1/assets/preview.css";
const JS_URL: &str = "rutile://preview/v1/assets/bridge.js";
